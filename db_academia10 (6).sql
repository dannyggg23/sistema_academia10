...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-08-2018 a las 16:04:03
...
(1, 'SERVICIOS', 'Servicios que ofrece la academia de fútbol ', 1),
(2, 'PRODUCTOS', 'Productos que ofrece la academia ', 1);
...
(1, '0504353210', 'PESANTEZ ALVAREZ TANIA MARISOL', 'LATACUNGA AVENIDA COTOPAXI', 'taniamarisol.pesantez@gmail.com', '032987568', '0983746576', '1533763349.jpg', '0504353210', '0504353210', 1, 'd21ac39a-0fc2-400f-b456-64b99d8ac6f1', 'JNSDKNDN IJIOJ IUNUI NUI UINH UINHUINH YUBGGN YKBGNYUKG UINHUH YGNG TFBTF TFVTB UILUILN YBGYNU TFBT KUNHH UILNHUH UBG KUNHU ULHLMUI GJBN UKNHU ULIHUKNH UINHU UINH UILNHLUIH ULNHUH UILNHULH ULHNUHM', 'Femenino', 'ENTRENADORA', '1995-12-12'),
(2, '0504353211', 'GARCIA GALARZA ARACELLY MARIBEL', 'AMBATO', 'maribelgarcia@gmail.com', '032675897', '0984746356', '1533769278.jpg', '0504353211', '0504353211', 1, 'a13a1b0d-e89d-45be-9749-18e1fe27cc24', 'SFSF SFF FE E F WE FWE F WE FWE F WEF WE F WEF WE F WE F WEF', 'Femenino', 'DEPORTES', '1992-04-23');
...
(1, 'SUCURSAL1', 'AMBATO HUACHI CHICO', '0987635654', 'DANNY GARCIA', 186, 1, '1533762337.jpg', '098767890987678987', '987689876699876'),
(2, 'SUCURSAL 2', 'LATACUNGA 2 DE MAYO', '0978657453', 'JONATHAN GARCIA', 36, 1, '1533762384.jpg', '987656789865678987', '78987655789876678');
...
(5, 'admin', '0000000000', 'admin', '0000000000', '0000000000', 'admin', 'admin', 'Admin', 'a32a9223ef49f4595df9eba858a3bea0d5c8e2ce5aeace4c43f1275e74b59d73', '1532544261.jpg', 1, 'd21ac39a-0fc2-400f-b456-64b99d8ac6f1');
...
--
ALTER TABLE `ficha_entrenador`
  MODIFY `idficha_entrenador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `sucursal_categorias`
  MODIFY `idsucursal_categorias` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
