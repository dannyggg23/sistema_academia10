...
class LoginAlumno extends REST_Controller {
    ...
    public function index_post()
    {
        ...
        $query = $this->db->get_where('alumno',$condiciones);
       ...
       $this->db->where('idalumno' , $usuario -> idalumno );//al id q vamos a afectar

       $hecho=$this->db->update('alumno',$actualizar_token);//actualizo el token
