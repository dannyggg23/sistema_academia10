              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Notificaciones Para Sucursales </h1>

                           <ul class="nav nav-tabs pull-right">
                           <li><a href="notificaciones.php">Todos</a></li>
                           <li class="active"><a href="notificaciones_sucursal.php">Sucursal</a></li>
...
<script type="text/javascript" src="scripts/notificaciones_sucursal.js"></script>
