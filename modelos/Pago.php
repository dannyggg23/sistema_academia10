...
Class Pago
{
  ...
  public function insertar($representante_idrepresentante,$usuario_idusuario,$fecha,$total,$tipo_documento,$serie_comprobante,$num_comprobante,$impuesto,$ficha_alumno_idficha_alumno,$numero_meses_pago,$precio_pago,$descuento_pago){
    $sql=sprintf("INSERT INTO `pago`( `representante_idrepresentante`, `usuario_idusuario`, `fecha`, `total`, `tipo_documento`, `estado`, `serie_comprobante`, `num_comprobante`,impuesto) VALUES ('%s','%s','%s','%s','%s','Aceptado','%s','%s','%s')",$representante_idrepresentante,$usuario_idusuario,$fecha,$total,$tipo_documento,$serie_comprobante,$num_comprobante,$impuesto);
